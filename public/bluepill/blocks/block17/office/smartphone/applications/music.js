$('.music').click(function(){
    ...
    $('.musicO').removeAttr('id', 'noneDisplay');
	$('.musicO').addClass('musicPlay');
	...
	$(".smartphoneTop").css('background', '#f38578')
	
	$('.jcarousel').on('jcarousel:visiblein', 'li', function(event, carousel) {
		let backgroundColor = $(this).attr("data-color");

	$(".smartphoneTop").css('background', backgroundColor)
	});
})
...
$(document).ready(function () {
	...
	for (let song of songs) {
		$("#songs").append('<li class="song" data-audio="' + song.audioFile + '" data-color="'+ song.color +'">' + 
			'<img src="' + song.cover + '">' +
			'<p class="song-title">' + song.title + '</p>' + '</br>'+
 ...
 */	player.pause();
	...
	$('.jcarousel').removeClass('carouselInitial');


  switch (true) {
    case $('#songs').hasClass('leftcarouselA'):

		$('#songs').addClass('leftcarouselBack');
		$('#songs').removeClass('leftcarouselA');

        break;
	case $('#songs').hasClass('leftcarouselB'):

		$('#songs').addClass('leftcarouselA');
		$('#songs').removeClass('leftcarouselB');

        break;
	case $('#songs').hasClass('leftcarouselC'):

		$('#songs').addClass('leftcarouselB');
		$('#songs').removeClass('leftcarouselC');

        break;
	case $('#songs').hasClass('leftcarouselD'):

		$('#songs').addClass('leftcarouselC');
		$('#songs').removeClass('leftcarouselD');

        break;
	case $('#songs').hasClass('leftcarouselBack'):
...
switch (true) {
	case $('#songs').hasClass('leftcarouselBack'):
		...
		$('#songs').addClass('leftcarouselA');
		$('#songs').removeClass('leftcarouselBack');
...
$('#play-btn').click(function() {
	if($('#play-btn i').hasClass('fa-play')){
