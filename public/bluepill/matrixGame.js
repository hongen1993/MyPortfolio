...
function enginestep() {
	...
	if (!gameover) {
		...
		for (var i = 0; i < enemies.length; i++) {
			var en = enemies[i];
			if (!en.danger) {
				ctx.strokeStyle = "rgba(41,49,51,"+en.op*2+")";
			} else {
				health -= 0.1;
			...
			if (!en.des) {
				...
				ctx.beginPath();
				ctx.arc(en.x,en.y+en.r/4, en.r/1, 2*Math.PI, Math.PI);
				ctx.stroke();
				ctx.beginPath();
				...
				ctx.beginPath();
				ctx.arc(en.x,en.y+en.r/6, en.r/1, 2*Math.PI, Math.PI);
				ctx.stroke();
				ctx.beginPath();
				ctx.arc(en.x,en.y, en.r, 0, 2*Math.PI);
				ctx.stroke();
				...
				ctx.beginPath();
				ctx.arc(en.x,en.y+en.r/2, en.r/1, 2*Math.PI, Math.PI);
				ctx.stroke();
				ctx.beginPath();
				ctx.arc(en.x,en.y, en.r, 0, 2*Math.PI);
				ctx.stroke();
				...
				ctx.beginPath();
				ctx.arc(en.x,en.y+en.r/-1, en.r/2, 2*Math.PI, Math.PI);
				ctx.stroke();
				ctx.beginPath();
				ctx.arc(en.x,en.y, en.r, 0, 2*Math.PI);
				ctx.stroke();
				...
				ctx.beginPath();
				ctx.arc(en.x,en.y+en.r/-1, en.r/4, 2*Math.PI, Math.PI);
				ctx.stroke();
				ctx.beginPath();
				ctx.arc(en.x,en.y, en.r, 0, 2*Math.PI);
				ctx.stroke();
				...
				ctx.beginPath();
				ctx.arc(en.x,en.y+en.r/-1, en.r/1, 2*Math.PI, Math.PI);
				ctx.stroke();
				ctx.beginPath();
				ctx.arc(en.x,en.y, en.r, 0, 2*Math.PI);
				ctx.stroke();
			...
			for (var s = 0; s < 12; s++) {
				...
				ctx.lineTo(en.x+Math.sin(a)*en.r*1,en.y+Math.cos(a)*en.r*3.5);
	    ...
	    if (health>30) {
	    	ctx.fillStyle='rgba(1,178,0,0.8)';
		} else {
	    	ctx.fillStyle='rgba(255,0,0,0.8)';
		}
		ctx.lineWidth = 2;
	    ctx.fillRect(130,25,healthprog*3,30);
	    ctx.strokeStyle = "rgb(1,255,1)";
	    ...
	    ctx.fillStyle='rgba(1,178,0,0.3)';
	    ...
	    againprog += (0-againprog)/100;

	}
	
	var gradient = ctx.createLinearGradient(50, 100, 180, 0);
	gradient.addColorStop("0", "magenta");
	gradient.addColorStop("0.5	" ,"blue");
	gradient.addColorStop("1.0", "green");
	var gradient2 = ctx.createLinearGradient(0, 180, 100, 50);
	...
	// Fill with gradient
		...
		ctx.beginPath();
		ctx.moveTo(pointer.x+(arm.x-pointer.x)/1,pointer.y+(arm.y-pointer.y)/3+10);
		ctx.lineTo(pointer.x+(arm.x-pointer.x)/5.5,pointer.y+(arm.y-pointer.y)/2.5+10);
		ctx.lineTo(pointer.x+(arm.x-pointer.x)/5,pointer.y+(arm.y-pointer.y)/2+10);
		...
		ctx.beginPath();
		ctx.moveTo(pointer.x+(arm.x-pointer.x)/3-10,pointer.y+(arm.y-pointer.y)/1);
		ctx.lineTo(pointer.x+(arm.x-pointer.x)/2.5-10,pointer.y+(arm.y-pointer.y)/5.5);
		ctx.lineTo(pointer.x+(arm.x-pointer.x)/2-10,pointer.y+(arm.y-pointer.y)/5);
		ctx.lineTo(pointer.x+(arm.x-pointer.x)/15-50,pointer.y+(arm.y-pointer.y)/15);
		...
		ctx.lineTo(pointer.x+(arm.x-pointer.x)/1.5,pointer.y+(arm.y-pointer.y)/10.5-50);
		ctx.lineTo(pointer.x+(arm.x-pointer.x)/1.2,pointer.y+(arm.y-pointer.y)/1.2-80);
		ctx.lineTo(pointer.x+(arm.x-pointer.x)/1.1,pointer.y+(arm.y-pointer.y)/1.1-100);
		ctx.stroke();

		ctx.beginPath();
		ctx.moveTo(arm2.x+pointer.x-(pointer.x)/1,pointer.y+(arm2.y-pointer.y)/3+10);
		ctx.lineTo(arm2.x+pointer.x-(pointer.x)/5.5,pointer.y+(arm2.y-pointer.y)/2.5+10);
		ctx.lineTo(arm2.x+pointer.x-(pointer.x)/5,pointer.y+(arm2.y-pointer.y)/2+10);
		...
		ctx.beginPath();
		ctx.moveTo(arm2.x+pointer.x-(pointer.x)/3-10,pointer.y+(arm2.y-pointer.y)/1);
		ctx.lineTo(arm2.x+pointer.x-(pointer.x)/2.5-10,pointer.y+(arm2.y-pointer.y)/5.5);
		ctx.lineTo(arm2.x+pointer.x-(pointer.x)/2-10,pointer.y+(arm2.y-pointer.y)/5);
		ctx.lineTo(arm2.x+pointer.x-(pointer.x)/15-50,pointer.y+(arm2.y-pointer.y)/15);
		...
		ctx.lineTo(arm2.x+pointer.x-(pointer.x)/1.5,pointer.y+(arm2.y-pointer.y)/10.5-50);
		ctx.lineTo(arm2.x+pointer.x-(pointer.x)/1.2,pointer.y+(arm2.y-pointer.y)/1.2-80);
		ctx.lineTo(arm2.x+pointer.x-(pointer.x)/1.1,pointer.y+(arm2.y-pointer.y)/1.1-100);
		ctx.stroke();
